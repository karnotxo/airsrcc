...
public class AppPrincipalFrame extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6527451162157091932L;
	/**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AppPrincipalFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
