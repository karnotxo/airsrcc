...
public final class HealthCheckGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.indra.srcc.airsrcc.lib.HealthCheckOuterClass.Service,
      com.indra.srcc.airsrcc.lib.HealthCheckOuterClass.Status> getCheckMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "check",
      requestType = com.indra.srcc.airsrcc.lib.HealthCheckOuterClass.Service.class,
      responseType = com.indra.srcc.airsrcc.lib.HealthCheckOuterClass.Status.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.indra.srcc.airsrcc.lib.HealthCheckOuterClass.Service,
      com.indra.srcc.airsrcc.lib.HealthCheckOuterClass.Status> getCheckMethod() {
    io.grpc.MethodDescriptor<com.indra.srcc.airsrcc.lib.HealthCheckOuterClass.Service, com.indra.srcc.airsrcc.lib.HealthCheckOuterClass.Status> getCheckMethod;
      ...
      synchronized (HealthCheckGrpc.class) {
        if ((getCheckMethod = HealthCheckGrpc.getCheckMethod) == null) {
          HealthCheckGrpc.getCheckMethod = getCheckMethod =
              io.grpc.MethodDescriptor.<com.indra.srcc.airsrcc.lib.HealthCheckOuterClass.Service, com.indra.srcc.airsrcc.lib.HealthCheckOuterClass.Status>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "check"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.indra.srcc.airsrcc.lib.HealthCheckOuterClass.Service.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.indra.srcc.airsrcc.lib.HealthCheckOuterClass.Status.getDefaultInstance()))
  ...
  public static abstract class HealthCheckImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void check(com.indra.srcc.airsrcc.lib.HealthCheckOuterClass.Service request,
        io.grpc.stub.StreamObserver<com.indra.srcc.airsrcc.lib.HealthCheckOuterClass.Status> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.indra.srcc.airsrcc.lib.HealthCheckOuterClass.Service,
                com.indra.srcc.airsrcc.lib.HealthCheckOuterClass.Status>(
                  this, METHODID_CHECK)))
          .build();
    }
  }
  ...
  public static final class HealthCheckBlockingStub extends io.grpc.stub.AbstractStub<HealthCheckBlockingStub> {
    ...
    /**
     */
    public com.indra.srcc.airsrcc.lib.HealthCheckOuterClass.Status check(com.indra.srcc.airsrcc.lib.HealthCheckOuterClass.Service request) {
  ...
  public static final class HealthCheckFutureStub extends io.grpc.stub.AbstractStub<HealthCheckFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.indra.srcc.airsrcc.lib.HealthCheckOuterClass.Status> check(
        com.indra.srcc.airsrcc.lib.HealthCheckOuterClass.Service request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CHECK:
          serviceImpl.check((com.indra.srcc.airsrcc.lib.HealthCheckOuterClass.Service) request,
              (io.grpc.stub.StreamObserver<com.indra.srcc.airsrcc.lib.HealthCheckOuterClass.Status>) responseObserver);
          break;
        default:
  ...
  private static abstract class HealthCheckBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.indra.srcc.airsrcc.lib.HealthCheckOuterClass.getDescriptor();
    }
